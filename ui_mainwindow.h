...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        radioButton->setGeometry(QRect(10, 50, 112, 23));
        MainWindow->setCentralWidget(centralWidget);
        menuBar = new QMenuBar(MainWindow);
        menuBar->setObjectName(QStringLiteral("menuBar"));
        menuBar->setGeometry(QRect(0, 0, 400, 22));
        menuHallo_Hannes = new QMenu(menuBar);
        menuHallo_Hannes->setObjectName(QStringLiteral("menuHallo_Hannes"));
        ...
        menuBar->addAction(menuHallo_Hannes->menuAction());
